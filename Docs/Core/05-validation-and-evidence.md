...
| Current host-mediated task control | **SAME-TASK INPUT/RESPONSE VERIFIED; ISOLATED WAKE UNPROVED** | CLOUD-028: exact B1 response to a `functionCallOutput` after older Q1 in a new completed turn; no observed tools. One allowance consumed; no independent Connector, fresh Browser or notification-receipt proof |
