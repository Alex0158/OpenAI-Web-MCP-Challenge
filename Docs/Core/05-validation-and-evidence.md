...
| Current host-mediated task control | **B1 JOINED-TURN RESPONSE VERIFIED; D1 IDLE CONTROL FAILED; WARM-STATE CANDIDATE MODELLED** | CLOUD-028: idle/empty/no-goal D1 failed waiting for a turn ID. Logs confirm warm-state reuse; earlier B1/Q1 overlap plus source-derived tests identify a possible orphaned optimistic start, not captured renderer state or a fix. Clean-task control needs separate approval. B1/D1 consumed, C1 unused; no independent Connector, Browser or notification-receipt proof |
