...
| [`RECORE-004`](RECORE-004-grant-control.md) | Implement Receiver-authenticated Grant inspection and atomic revocation without adding a production administration surface | `specified` |
