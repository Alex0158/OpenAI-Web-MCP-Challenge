...
| [`CLOUD-023`](CLOUD-023-standing-receiver-source-gate.md) | Additive standing Receiver kernel and fail-closed committed-source preflight | Core source pin and minimum real-store trace `locally_verified`; Receiver source closure, full release conformance, and public controls remain open |
