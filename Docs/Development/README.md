...
| [`DOCS-006`](DOCS-006-bound-task-product-restoration.md) | Restore existing-task, notification-only product authority and preserve exact compatibility evidence | Documentation verification pending; accepted target, not runtime implementation |
