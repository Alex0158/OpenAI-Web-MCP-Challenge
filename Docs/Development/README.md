...
| [`SDK-005`](SDK-005-cloud-receiver-v2-full-chain-contract.md) | Prepare SDK-to-Receiver full-chain contract coverage through downstream acknowledgement | `verification_pending` — SDK Host/Event/Claim green; Cloud Feature 5/6 own tests `10/10`; received Acknowledgement `4/5` with an ACK-003 error-code mismatch; combined flow open |
