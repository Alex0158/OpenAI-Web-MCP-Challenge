...
The reviewed 048 deterministic/browser split now makes `RS-WO-047-03` dispatch-admissible after a
fresh source baseline; its independent browser closure remains open.
