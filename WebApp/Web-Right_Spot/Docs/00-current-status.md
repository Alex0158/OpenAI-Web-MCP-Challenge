...
authority Builder `Herschel`, and `RS-WO-015-02` is ready for independent verification; in parallel,
...
`RS-WO-015-02` authority verification; it has no assigned worker yet. The next media primitive
