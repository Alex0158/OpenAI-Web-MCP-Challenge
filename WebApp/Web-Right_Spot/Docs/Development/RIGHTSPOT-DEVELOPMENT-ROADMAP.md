...
authority Builder, while main-thread `RS-WO-017-01` owns the reviewed local asset gate;
...
authority implementation gate and `RS-WO-017-01` is the main-thread asset gate. Prior
