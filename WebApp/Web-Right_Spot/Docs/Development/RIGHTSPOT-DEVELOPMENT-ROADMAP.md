...
registered `RIGHTSPOT-022` as a separate CSS-only responsive repair. `RS-WO-022-01` is in progress in
...
in-progress `RIGHTSPOT-022`; its `RS-WO-022-01` is in progress in persistent supporting task
