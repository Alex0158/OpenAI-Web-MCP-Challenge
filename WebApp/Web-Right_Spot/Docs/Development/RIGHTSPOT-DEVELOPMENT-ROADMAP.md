...
integrated cross-role regression check. `RS-WO-011-01` passed independent verification and is
integrated at product commit `7ff0fbd`; its read-model seam remains separate from any future consumer.
The prior out-of-scope tracked verifier mutation remains preserved.
