...
integrated cross-role regression check. `RS-WO-011-01` is frozen at candidate `5b05c78` and its
independent verifier `RS-WO-011-02` is assigned. The prior out-of-scope tracked verifier mutation
remains preserved.
