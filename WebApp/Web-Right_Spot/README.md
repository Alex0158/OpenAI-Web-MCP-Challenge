...
**Implementation:** Tenant and agent role pages, durable workflow HTTP/DTO transport, Favourites, listing-interest projection, local synthetic media, and responsive navigation are integrated; the bounded F-01–F-05 audit findings are closed within their recorded claims, while the deterministic reset-command defect F-06 is being repaired through RIGHTSPOT-028
