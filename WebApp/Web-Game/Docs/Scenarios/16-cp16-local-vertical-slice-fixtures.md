...
**Bounded implementation:** [SK-TASK-050](../Tasks/SK-TASK-050-cp16-local-causal-slice-pre-agent-gates.md), [SK-TASK-069](../Tasks/SK-TASK-069-cp16-local-causal-page-recall-composition.md), [SK-TASK-070](../Tasks/SK-TASK-070-cp16-local-causal-restart-recall-continuity.md), and [SK-TASK-071](../Tasks/SK-TASK-071-cp16-real-event-burst-page-context.md)  
**Browser probe:** [SK-TASK-063](../Tasks/SK-TASK-063-cp16-independent-browser-context-capability-probe.md)  
**Evidence:** [SK-EVID-039](../Evidence/SK-EVID-039-cp16-local-causal-slice-pre-agent-gates-runtime-verification.md), [Validation/61](../Validation/61-cp16-local-causal-slice-runtime-cross-functional-audit.md), [SK-EVID-056](../Evidence/SK-EVID-056-cp16-local-causal-page-recall-composition-runtime-verification.md), [Validation/82](../Validation/82-cp16-local-causal-page-recall-composition-runtime-cross-functional-audit.md), [SK-EVID-057](../Evidence/SK-EVID-057-cp16-local-causal-restart-recall-continuity-runtime-verification.md), [Validation/83](../Validation/83-cp16-local-causal-restart-recall-continuity-runtime-cross-functional-audit.md), [SK-EVID-058](../Evidence/SK-EVID-058-cp16-real-event-burst-page-context-runtime-verification.md), [Validation/84](../Validation/84-cp16-real-event-burst-page-context-runtime-cross-functional-audit.md), and [SK-EVID-051](../Evidence/SK-EVID-051-cp16-independent-browser-context-capability-probe.md)  
...
page HTTP reread and bounded recall, the restart composition verifies continuity across a clean local
entrypoint boundary, and the current IAB probe verifies a two-tab limitation and close-one
