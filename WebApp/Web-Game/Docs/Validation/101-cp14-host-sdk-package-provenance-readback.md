...
**Status:** VERIFIED STATIC READBACK; V0.2 HOST SDK GATE OPEN  
**Date:** 2026-09-04  
...
| Receiver | Active `saas-boilerplate` routes expose `/v0.2/events`, `/v0.2/delivery-claims`, and `/v0.2/delivery-acknowledgements`; standing Consent enrollment is not a public route. | Event transport alone cannot complete a Game standing binding or full trace. |
