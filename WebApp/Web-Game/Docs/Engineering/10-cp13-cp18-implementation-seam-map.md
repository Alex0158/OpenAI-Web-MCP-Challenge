...
5. Before any live external adapter code, process [`SK-TASK-076`](../Tasks/SK-TASK-076-cp14-cloud-receiver-v2-game-adaptation.md)
   against the merged SDK/Core/Connector source and selected Receiver Preview. Keep the Game publication lease separate from the
