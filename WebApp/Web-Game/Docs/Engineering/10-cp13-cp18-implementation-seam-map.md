...
8. Use [`SK-TASK-077`](../Tasks/SK-TASK-077-cp17-host-decision-and-deployment-preflight.md) and the
   ...
   owns the local production-like identity/bootstrap seam and focused matrix; hosted Railway and
   Clerk readback remain required before CP-18. CP-18 consumes the exact hosted evidence and cannot
