...
**Date:** 2026-09-03
**Scope:** `reentry-host-sdk` only. No Cloud Receiver, Local Connector, shared Core, package
version, deployment, or publish changes were made.

This is a historical verification report from before the root reorganization and the package
metadata update to `0.3.2`; its recorded `0.3.1` package result remains an as-of claim.
...
| `npm run build` from `reentry-host-sdk/app` | **Passed** under Node `v26.8.1`; Next.js `16.3.4` |
...
- `reentry-host-sdk/src/server.mjs`
- `reentry-host-sdk/README.md`
- `reentry-host-sdk/test/reentry-facade.test.mjs`
- `reentry-host-sdk/SDK-FACADE-REPORT.md`
- `reentry-host-sdk/app/app/_lib/reentry-demo.mjs`
- `reentry-host-sdk/app/app/api/reentry/consent/route.js`
- `reentry-host-sdk/app/app/api/reentry/consent/status/route.js`
- `reentry-host-sdk/app/app/api/reentry/event/route.js`
- `reentry-host-sdk/app/test/reentry-demo-routes.test.mjs`

Pre-existing uncommitted paths preserved under the same component were:

- `reentry-host-sdk/app/AGENTS.md`
- `reentry-host-sdk/app/CLAUDE.md`
- `reentry-host-sdk/app/app/layout.jsx`
- `reentry-host-sdk/app/app/page.jsx`
- `reentry-host-sdk/app/app/page.module.css`
- `reentry-host-sdk/app/next.config.mjs`
- `reentry-host-sdk/app/package-lock.json`
- `reentry-host-sdk/app/package.json`
- `reentry-host-sdk/app/page.jsx`
- `reentry-host-sdk/src/client.mjs`
...
```sh
cd /path/to/<checkout>/reentry-host-sdk
npm run verify
